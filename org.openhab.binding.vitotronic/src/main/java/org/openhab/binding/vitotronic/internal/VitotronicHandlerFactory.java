 ...
 */
public class VitotronicHandlerFactory extends BaseThingHandlerFactory implements org.eclipse.smarthome.core.thing.binding.ThingHandlerFactory{
    ...
    public boolean supportsThingType(ThingTypeUID thingTypeUID) {
    	logger.trace("Ask Handler for Suported Thing {}", VitotronicBindingConstants.SUPPORTED_THING_TYPES_UIDS.contains(thingTypeUID));
