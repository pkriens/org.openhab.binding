...
import static org.openhab.binding.network.NetworkBindingConstants.PARAMETER_HOSTNAME;
 ...
 */
@Component
public class NetworkDiscoveryService extends AbstractDiscoveryService implements org.eclipse.smarthome.config.discovery.DiscoveryService{
