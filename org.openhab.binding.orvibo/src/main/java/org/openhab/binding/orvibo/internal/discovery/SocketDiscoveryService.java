 ...
 */
@Component
public class SocketDiscoveryService extends AbstractDiscoveryService implements SocketDiscoveryListener, org.eclipse.smarthome.config.discovery.DiscoveryService {
